...
// Standard is if a transition occurs before VW_RAMP_TRANSITION (80) in the
// ramp, the ramp is retarded by adding VW_RAMP_INC_RETARD (11) else by adding
// VW_RAMP_INC_ADVANCE (29) If there is no transition it is adjusted by
// VW_RAMP_INC (20)
